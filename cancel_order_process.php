...
<body class="bg-gray-50">
    ...
    <main class="pt-20 pb-48 px-4 container mx-auto">
        ...
        <div class="text-center mt-6 space-y-3">
            <a href="riwayat.php" class="w-full block bg-blue-500 text-white text-center py-3 px-6 rounded-lg shadow-lg font-bold hover:bg-blue-600 transition">Lihat Riwayat Pesanan</a>
